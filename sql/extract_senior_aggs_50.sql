/* 
    Script:   Aggregated Over 50's Rankings
    Created:  2019-05-18
    Author:   Michael George / 2015GEOR02
   
    Purpose:  Provide a comprehensive view of the Over-50's performances in competition.
...
INTO OUTFILE '/home/jovyan/work/wca-ipy/data/public/extract/known_senior_averages_agg_50.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
FROM
(
...
INTO OUTFILE '/home/jovyan/work/wca-ipy/data/public/extract/known_senior_singles_agg_50.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
FROM
(   
