...
INTO OUTFILE '/home/jovyan/work/wca-ipy/data/private/latest/wca_averages_agg.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
FROM RanksAverage
...
INTO OUTFILE '/home/jovyan/work/wca-ipy/data/private/latest/wca_singles_agg.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
FROM RanksSingle
