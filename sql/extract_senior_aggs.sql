...
INTO OUTFILE '/home/jovyan/work/wca-ipy/data/private/known_senior_averages_agg.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
FROM
(
...
INTO OUTFILE '/home/jovyan/work/wca-ipy/data/private/known_senior_singles_agg.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
FROM
(   
