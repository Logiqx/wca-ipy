...
events = \
[
    ('333', '3x3x3 Cube', '10', 'time', 60, 120, 180),
    ('222', '2x2x2 Cube', '20', 'time', 30, 60, 60),
    ('444', '4x4x4 Cube', '30', 'time', 120, 180, 240),
    ('555', '5x5x5 Cube', '40', 'time', 240, 360, 360),
    ('666', '6x6x6 Cube', '50', 'time', 300, 420, 540),
    ('777', '7x7x7 Cube', '60', 'time', 480, 540, 840),
    ('333bf', '3x3x3 Blindfolded', '70', 'time', 180, 300, 360),
    ('333fm', '3x3x3 Fewest Moves', '80', 'number', 60, 60, 60),
    ('333oh', '3x3x3 One-Handed', '90', 'time', 90, 120, 180),
    ('333ft', '3x3x3 With Feet', '100', 'time', 180, 300, 420),
    ('clock', 'Clock', '110', 'time', 60, 60, 60),
    ('minx', 'Megaminx', '120', 'time', 180, 240, 360),
    ('pyram', 'Pyraminx', '130', 'time', 30, 60, 60),
    ('skewb', 'Skewb', '140', 'time', 40, 60, 60),
    ('sq1', 'Square-1', '150', 'time', 90, 120, 120),
