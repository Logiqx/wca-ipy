...
[
    ...
    ('555', '5x5x5 Cube', '40', 'time', 240, 360, 420),
    ('666', '6x6x6 Cube', '50', 'time', 300, 480, 600),
    ('777', '7x7x7 Cube', '60', 'time', 480, 780, 960),
    ('333bf', '3x3x3 Blindfolded', '70', 'time', 180, 360, 420),
    ...
    ('clock', 'Clock', '110', 'time', 60, 60, 120),
    ('minx', 'Megaminx', '120', 'time', 240, 360, 480),
    ('pyram', 'Pyraminx', '130', 'time', 30, 60, 60),
    ('skewb', 'Skewb', '140', 'time', 40, 60, 60),
    ('sq1', 'Square-1', '150', 'time', 90, 120, 180),
