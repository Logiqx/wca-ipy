...
events = \
[
    ('333', '3x3x3 Cube', '10', 'time', 180, 360),
    ('222', '2x2x2 Cube', '20', 'time', 60, 120),
    ('444', '4x4x4 Cube', '30', 'time', 180, 360),
    ('555', '5x5x5 Cube', '40', 'time', 240, 480),
    ('666', '6x6x6 Cube', '50', 'time', 360, 600),
    ('777', '7x7x7 Cube', '60', 'time', 540, 600),
    ('333bf', '3x3x3 Blindfolded', '70', 'time', 240, 480),
    ('333fm', '3x3x3 Fewest Moves', '80', 'number', 60, 60),
    ('333oh', '3x3x3 One-Handed', '90', 'time', 120, 240),
    ('333ft', '3x3x3 With Feet', '100', 'time', 240, 360),
    ('clock', 'Clock', '110', 'time', 60, 120),
    ('minx', 'Megaminx', '120', 'time', 240, 480),
    ('pyram', 'Pyraminx', '130', 'time', 60, 120),
    ('skewb', 'Skewb', '140', 'time', 60, 120),
    ('sq1', 'Square-1', '150', 'time', 120, 240),
    ('444bf', '4x4x4 Blindfolded', '160', 'time', 0, 0),
    ('555bf', '5x5x5 Blindfolded', '170', 'time', 0, 0),
    ('333mbf', '3x3x3 Multi-Blind', '180', 'multi', 0, 0)
]
