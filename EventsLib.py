...
[
    ...
    ('444', '4x4x4 Cube', '30', 'time', 180, 360, 420),
    ('555', '5x5x5 Cube', '40', 'time', 300, 480, 600),
    ('666', '6x6x6 Cube', '50', 'time', 360, 540, 660),
    ('777', '7x7x7 Cube', '60', 'time', 540, 780, 900),
    ('333bf', '3x3x3 Blindfolded', '70', 'time', 300, 420, 480),
    ...
    ('minx', 'Megaminx', '120', 'time', 300, 360, 420),
